    ...
    pub fn new() -> Result<LanguageTokenizer, String> {
        let result = LanguageTokenizer {
            lexer: LazyLexer::new(RegexAst::new("[0-9][0-9]*")?, Rc::new(|s| Tokens::IntegerNumber(i32::from_str_radix(&s, 10).unwrap())))
                ...
                .or(LazyLexer::new(RegexAst::new("\\|")?, Rc::new(|_| Tokens::BinaryOrSymbol)))
                .or(LazyLexer::new(RegexAst::new("&")?, Rc::new(|_| Tokens::BinaryAndSymbol)))
                .or(LazyLexer::new(RegexAst::new("^")?, Rc::new(|_| Tokens::BinaryXorSymbol)))
